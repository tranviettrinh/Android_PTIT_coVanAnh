...
public class MonAdapter extends BaseAdapter {
    ...
    private List<MonAn_B17DCAT191> loaiList= new ArrayList<>();

    public MonAdapter(List<MonAn_B17DCAT191> loaiList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView nametxt, destxt, timetxt;
        ...
        destxt.setText(String.valueOf(loaiList.get(position).getPrice()));
        timetxt.setText(String.valueOf(loaiList.get(position).getTime()));
        return convertView;
    }
}
